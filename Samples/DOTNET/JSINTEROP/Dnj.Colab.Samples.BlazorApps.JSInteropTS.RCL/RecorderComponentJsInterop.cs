...
namespace Dnj.Colab.Samples.BlazorApps.JSInteropTS.RCL;
...
public class RecorderComponentJsInterop : IAsyncDisposable
{
    ...
    public RecorderComponentJsInterop(IJSRuntime jsRuntime)
    {
        ...
        _moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
            "import", "./_content/Dnj.Colab.Samples.BlazorApps.JSInteropTS.RCL/RecorderComponentJsInterop.js").AsTask());
